...
<div className="hero min-h-[800px] bg-base-200 ">
  ...
  <div className="hero-content relative  z-10  w-auto text-center text-neutral-content">
    ...
    <button   className="  btn btn-sm lg:btn-md z-0  right-10 top-10  flex my-auto mx-3 absolute z-10 lg:right-3 lg:top-[137px] mt-2  bg-[#79d0e3]">Search</button></form>
    {/* <p className=" text-3xl absolute right-16 top-[600px]">Time : {times.toLocaleTimeString()}</p> */}
    </div>
    
  </div>
  {/* end */}
  <div className="hero-content z-0  lg:-mb-96 lg:gap-40 flex-col lg:-mt-48 lg:flex-row-reverse">
    <img src="https://i.ibb.co/2knmxtb/reputation-management-small-business.jpg" className="max-w-sm rounded-lg shadow-2xl mt-10" />
    <div>
      <h1 className=" text-2xl lg:text-4xl font-bold">Post for help!</h1>
      <p className="py-6">A forum site is an online platform for discussions and information sharing. Users engage in conversations, ask questions, and connect with others  who share similar interests. Features like categories, threads, and moderation  tools ensure a productive and respectful community environment.</p>
